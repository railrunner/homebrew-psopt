...
class Psopt < Formula
  ...
  sha256 'e7a6d76b6c604a17a19c2eb878b3c6bb47ab6c37bce9b805454a0b563a57cebe'
  version '4.0'
  env :std
  fails_with :clang
  ...
  def install
    ...
    inreplace ['PSOPT/lib/Makefile', 'PSOPT/examples/Makefile_linux.inc'] do |s|
      ...
      s.gsub! 'CXXFLAGS      = -O0 -g', 'CXXFLAGS      = -O0 -g -std=c++11 stdlib=libc++ -Wno-keyword-macro'
    end
    
    inreplace 'dmatrix/lib/Makefile', 'CXXFLAGS      = -O0 -g','CXXFLAGS      = -O0 -g -std=c++11 stdlib=libc++ -Wno-keyword-macro'
